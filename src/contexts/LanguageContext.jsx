...
const translations = {
  en: {
    ...
    rateOutdated: 'Rate may be outdated',
    ...
    sleepPrompt: 'Log your sleep hours for today',
    ...
    dailyCompletionLast7: 'Daily completion (last 7 days)',
    weeklyCompletionLast4: 'Weekly completion (last 4 weeks)',
    dailyCompletionPercent: 'Daily completion %',
    weeklyCompletionPercent: 'Weekly completion %',
    custom: 'Custom',
    general: 'General',
    ...
    landingBadge: 'Habit & Budget Tracker',
    landingTitle: 'Build habits, master budgets, and keep wellness in sync.',
    landingSubtitle: 'A calm, beautiful workspace for everyday progress. Track routines, plan expenses, and manage tasks with clarity—designed for focus and ease.',
    landingOpenDashboard: 'Open your dashboard',
    landingExplore: 'Explore features',
    landingWelcome: 'Welcome back',
    landingSyncing: 'Syncing your Telegram profile...',
    landingDailyFocus: 'Daily focus',
    landingBudgetPulse: 'Budget pulse',
    landingTasksFlow: 'Tasks in flow',
    landingHabitsTitle: 'Habits that stick',
    landingHabitsDesc: 'Visual streaks, calendar focus, and daily check-ins tailored to your pace.',
    landingBudgetTitle: 'Budgeting made human',
    landingBudgetDesc: 'Plan with intention, categorize expenses, and see live monthly summaries.',
    landingWellnessTitle: 'Wellness & planning',
    landingWellnessDesc: 'Sleep notes, mood checkpoints, and task boards keep your week balanced.',
    landingSummaryTitle: 'Everything you need in one calm workspace.',
    landingSummaryDesc: 'No clutter, no noise. Only the tools you need to nurture habits, plan budgets, and move through your week with confidence.',
    ...
    startByAddingFirstHabit: 'Start by adding your first habit above',
  },
  ru: {
    ...
    startByAddingFirstHabit: 'Начните с добавления первой привычки выше',
    ...
    noBudgetItems: 'Пока нет записей бюджета',
    rateOutdated: 'Курс может быть устаревшим',
    deletePlanConfirm: 'Удалить этот план?',
    allFieldsRequired: 'Все поля обязательны',
    sleepTracking: 'Отслеживание сна',
    addSleepEntry: 'Добавить сон',
    sleepToday: 'Сон за сегодня',
    sleepPrompt: 'Запишите количество часов сна за сегодня',
    sleepHours: 'Часы сна',
    sleep: 'Сон',
    ...
    noData: 'Нет данных',
    progressOverview: 'Общий прогресс',
    dailyCompletionLast7: 'Ежедневное выполнение (последние 7 дней)',
    weeklyCompletionLast4: 'Еженедельное выполнение (последние 4 недели)',
    dailyCompletionPercent: 'Ежедневное выполнение %',
    weeklyCompletionPercent: 'Еженедельное выполнение %',
    custom: 'Свой вариант',
    general: 'Общее',
    ...
    landingBadge: 'Трекер привычек и бюджета',
    landingTitle: 'Формируйте привычки, управляйте бюджетом и держите баланс.',
    landingSubtitle: 'Спокойное пространство для ежедневного прогресса. Отмечайте привычки, планируйте расходы и управляйте задачами.',
    landingOpenDashboard: 'Открыть дашборд',
    landingExplore: 'Посмотреть функции',
    landingWelcome: 'С возвращением',
    landingSyncing: 'Синхронизируем профиль Telegram...',
    landingDailyFocus: 'Фокус дня',
    landingBudgetPulse: 'Бюджет сегодня',
    landingTasksFlow: 'Задач в работе',
    landingHabitsTitle: 'Привычки, которые закрепляются',
    landingHabitsDesc: 'Серии, календарь и ежедневные отметки в удобном формате.',
    landingBudgetTitle: 'Бюджет без стресса',
    landingBudgetDesc: 'Планируйте цели, фиксируйте траты и смотрите итог в реальном времени.',
    landingWellnessTitle: 'Баланс и самочувствие',
    landingWellnessDesc: 'Сон, заметки и задачи помогают держать ритм.',
    landingSummaryTitle: 'Всё в одном спокойном рабочем пространстве.',
    landingSummaryDesc: 'Без лишнего шума — только нужные инструменты для привычек, бюджета и задач.',
